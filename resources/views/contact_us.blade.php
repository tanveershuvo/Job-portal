...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pricing-section-heading my-4 text-center">
                    <h1>Contact Us</h1>
                </div>
            </div>
        </div>

        <div class="row col-offset-2 mb-4">
            <div class="col-md-5" style="background-color:#957db8da;">
                <img src="{{asset('images/aa.png')}}" width="100%" height="100%" alt="">
            </div>
            <div class="col-md-7 border border-secondary bg-white pt-4">
