                ...
                <div class="blog-single-content pt-3 pb-5">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group row{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">@lang('app.name') <span
                                    class="text-danger">*</span></label>

                            <div class="col-md-6">
                                <input id="name" type="text"
                                    class="form-control {{e_form_invalid_class('name', $errors)}}" name="name"
                                    value="{{ old('name') }}">
                        ...
                        <div class="form-group row{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">@lang('app.email_address') <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="form-group row{{ $errors->has('message') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="message"
                                    class="form-control {{e_form_invalid_class('message', $errors)}}"
