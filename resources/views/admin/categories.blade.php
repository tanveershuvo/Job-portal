            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control @error('category_name') is-invalid @enderror"
                        ...
                        placeholder="@lang('app.category_name')">
    ...
    <div class="col-md-12">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('edit_categories', $category->id) }}" class="btn btn-info"><i
                            class="la la-pencil"></i> </a>
                    <a href="javascript:;" class="btn btn-danger category_delete" data-id="{{ $category->id }}"><i
