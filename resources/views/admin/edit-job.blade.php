        ...
        <div class="col-md-10">
            ...
            <form method="post" action="">
                ...
                <div class="form-group row {{ $errors->has('company_name')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control {{e_form_invalid_class('company_name', $errors)}}" id="company_name" value="{{ $job->company_name }}" name="company_name" placeholder="@lang('app.company_name')">
