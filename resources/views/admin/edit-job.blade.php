            ...
            <div class="form-group row {{ $errors->has('company_name')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control {{e_form_invalid_class('company_name', $errors)}}"
                        id="company_name" value="{{ $job->company_name }}" name="company_name"
            ...
            <div class="form-group row {{ $errors->has('job_title')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control {{e_form_invalid_class('job_title', $errors)}}"
                        id="job_title" value="{{ $job->job_title }}" name="job_title"
            ...
            <div class="form-group row {{ $errors->has('position')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control {{e_form_invalid_class('position', $errors)}}" id="position"
                        value="{{$job->position}}" name="position" placeholder="@lang('app.position')">
            ...
            <div class="form-group row {{ $errors->has('category')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <select class="form-control {{e_form_invalid_class('category', $errors)}}" name="category"
                        ...
                        <option value="{{$category->id}}" {{selected($category->id, $job->category_id)}}>
                ...
                <div class="col-sm-8">
                    ...
                    <div class="price_input_group">
                        ...
                        <select class="form-control {{e_form_invalid_class('salary_cycle', $errors)}}"
                            name="salary_cycle">
                            <option value="monthly" {{selected('monthly', $job->salary_cycle)}}>@lang('app.monthly')
                            </option>
                            <option value="yearly" {{selected('yearly', $job->salary_cycle)}}>@lang('app.yearly')
                            </option>
                            <option value="weekly" {{selected('weekly', $job->salary_cycle)}}>@lang('app.weekly')
                            </option>
                            <option value="daily" {{selected('daily', $job->salary_cycle)}}>@lang('app.daily')</option>
                            <option value="hourly" {{selected('hourly', $job->salary_cycle)}}>@lang('app.hourly')
                            </option>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <input type="number" class="form-control {{e_form_invalid_class('salary', $errors)}}"
                                id="salary" value="{{ $job->salary }}" name="salary" placeholder="@lang('app.salary')">
                        </div>
                        <div class="col-md-6">
                            <label> <input type="checkbox" name="is_negotiable" value="1"
                                    {{checked('1', $job->is_negotiable)}}> @lang('app.is_negotiable')</label>
                        </div>
                    </div>
            ...
            <div class="form-group row {{ $errors->has('salary_upto')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control {{e_form_invalid_class('salary_upto', $errors)}}"
                        id="salary_upto" value="{{$job->salary_upto}}" name="salary_upto"
                ...
                <div class="col-sm-8">
                    ...
                    <div class="price_input_group">
                        ...
                        <select class="form-control {{e_form_invalid_class('salary_currency', $errors)}}"
                            ...
                            <option value="{{$currency}}" {{selected($currency, $job->salary_currency)}}>{{$currency}} |
            ...
            <div class="form-group row {{ $errors->has('vacancy')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control {{e_form_invalid_class('vacancy', $errors)}}" id="vacancy"
                        value="{{$job->vacancy}}" name="vacancy" placeholder="@lang('app.vacancy')">
            ...
            <div class="form-group row {{ $errors->has('gender')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <select class="form-control {{e_form_invalid_class('gender', $errors)}}" name="gender" id="gender">
                        ...
                        <option value="transgender" {{selected('transgender', $job->gender)}}>@lang('app.transgender')
                        </option>
                    </select>
            ...
            <div class="form-group row {{ $errors->has('job_type')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <select class="form-control {{e_form_invalid_class('job_type', $errors)}}" name="job_type"
                        id="job_type">
                        <option value="full_time" {{selected('full_time', $job->job_type)}}>@lang('app.full_time')
                        </option>
                        <option value="internship" {{selected('internship', $job->job_type)}}>@lang('app.internship')
                        </option>
                        <option value="part_time" {{selected('part_time', $job->job_type)}}>@lang('app.part_time')
                        </option>
                        <option value="contract" {{selected('contract', $job->job_type)}}>@lang('app.contract')</option>
                        <option value="temporary" {{selected('temporary', $job->job_type)}}>@lang('app.temporary')
                        </option>
                        <option value="commission" {{selected('commission', $job->job_type)}}>@lang('app.commission')
                        </option>
                        <option value="internship" {{selected('internship', $job->job_type)}}>@lang('app.internship')
                        </option>
                    </select>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <input type="number"
                                ...
                                id="experience_required_years" value="{{$job->experience_required_years}}"
                        ...
                        <div class="col-md-6">
                            <label> <input type="checkbox" name="experience_plus" value="1"
                                    {{checked('1', $job->experience_plus)}}> @lang('app.plus')</label>
                        </div>
                    </div>
            ...
            <div class="form-group row {{ $errors->has('deadline')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control {{e_form_invalid_class('deadline', $errors)}} date_picker"
                        id="deadline" value="{{$job->deadline->format('Y-m-d')}}" name="deadline"
                        placeholder="@lang('app.deadline')">
            ...
            <div class="form-group row {{ $errors->has('responsibilities')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <textarea name="responsibilities"
                        ...
                        rows="3">{!! $job->responsibilities !!}</textarea>
            ...
            <div class="form-group row {{ $errors->has('educational_requirements')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <textarea name="educational_requirements"
                        ...
                        rows="3">{!! $job->educational_requirements !!}</textarea>
            ...
            <div class="form-group row {{ $errors->has('experience_requirements')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <textarea name="experience_requirements"
                        ...
                        rows="3">{!! $job->experience_requirements !!}</textarea>
            ...
            <div class="form-group row {{ $errors->has('additional_requirements')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <textarea name="additional_requirements"
                        ...
                        rows="3">{!! $job->additional_requirements !!}</textarea>
            ...
            <div class="form-group row {{ $errors->has('apply_instruction')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <textarea name="apply_instruction"
                        ...
                        rows="3">{!! $job->apply_instruction !!}</textarea>
