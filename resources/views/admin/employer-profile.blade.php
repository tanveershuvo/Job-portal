    ...
    <div class="col-md-10">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="form-group row {{ $errors->has('company')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control {{e_form_invalid_class('company', $errors)}}" id="company"
                        value="{{ $user->company }}" name="company" placeholder="@lang('app.company')"
                        disabled="disabled">
            ...
            <div class="form-group row {{ $errors->has('company_size')? 'has-error':'' }}">
                <label for="company_size" class="col-sm-4 control-label">@lang('app.company_size')
                    (@lang('app.employees'))</label>
                <div class="col-sm-8">
                    <select class="form-control {{e_form_invalid_class('company_size', $errors)}}" name="company_size"
                        id="company_size">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input id="address_2" type="text"
                        class="form-control{{ $errors->has('address_2') ? ' is-invalid' : '' }}" name="address_2"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <input id="website" type="text"
                        class="form-control{{ $errors->has('website') ? ' is-invalid' : '' }}" name="website"
                        value="{{$user->website}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <button type="submit" class="btn btn-primary"> <i class="la la-refresh"></i>
                        @lang('app.update_employer_profile')</button>
                </div>
            </div>
        </form>
