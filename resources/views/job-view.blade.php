    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <p>
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#applyJobModal"><i
                            class="la la-calendar-plus-o"></i> @lang('app.apply_online') </button>
                    ...
                    <button type="button" class="btn btn-success employer-follow-button"
                        data-employer-id="{{$job->employer->id}}"><i class="la la-minus-circle"></i>
                        @lang('app.unfollow') {{$employer->company}} </button>
                    @else
                    <button type="button" class="btn btn-success employer-follow-button"
                        data-employer-id="{{$job->employer->id}}"><i class="la la-plus-circle"></i> @lang('app.follow')
                        {{$employer->company}} </button>
                    @endif
                    @endif
            ...
            <div class="col-md-4">
                <div class="job-view-lead-position-box">
                    ...
                    <p class="m-0">
                        <i class="la la-money"></i> {!! get_amount($job->salary, $job->salary_currency) !!}
                        @if($job->salary_upto) - {!! get_amount($job->salary_upto, $job->salary_currency) !!} @endif /
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="alert alert-warning">
                <i class="la la-warning"></i> You are currently viewing this job in private mode. Public will not be
                able to see this until publish.
            </div>
            @endif
            ...
            <div class="job-view-container box-shadow bg-white p-4 mb-4">
                ...
                <div class="terms-msg mt-5 mb-3">
                    <p class="text-small text-muted font-italic">By applying to a job using {{get_option('site_name')}}
                        you are agreeing to comply with and be subject to the {{get_option('site_name')}} <a
                            href="">Terms and Conditions</a> for use of our website. To use our website, you must agree
                        with the <a href="">Terms and Conditions</a> and both meet and comply with their provisions.
                    </p>
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="widget-box bg-white p-3 mb-3 box-shadow">
                ...
                <p>
                    ...
                    {{$job->experience_required_years}}@if($job->experience_plus)+@endif @lang('app.years')
                </p>
                @endif
            ...
            <div class="widget-box bg-white p-3 box-shadow">
                ...
                <div class="additional-job-action-box">
                    ...
                    <p><a href="{{route('jobs_by_employer', $job->employer->company_slug)}}"><i
                                class="la la-list-ul"></i> @lang('app.check_all_job_employer') </a> </p>
                    <p><a href="javascript:;" data-toggle="modal" data-target="#jobFlagModal"><i class="la la-flag"></i>
                            @lang('app.flag_this_job') </a> </p>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group {{ $errors->has('name')? 'has-error':'' }}">
                        ...
                        <input type="text" class="form-control {{e_form_invalid_class('name', $errors)}}" id="name"
                            name="name" value="{{old('name')}}" placeholder="@lang('app.your_name')">
                    ...
                    <div class="form-group {{ $errors->has('message')? 'has-error':'' }}">
                        ...
                        <textarea class="form-control {{e_form_invalid_class('message', $errors)}}" id="message"
                            name="message" placeholder="@lang('app.your_message')">{{old('message')}}</textarea>
        ...
        <div class="modal-content">
            <form action="{{route('flag_job_post', $job->id)}}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="message-text" class="control-label">@lang('app.message'):</label>
                        <textarea class="form-control  {{e_form_invalid_class('message', $errors)}}"
            ...
            <form action="{{route('share_by_email')}}" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{e_form_invalid_class('receiver_name', $errors)}}"
                            name="receiver_name">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{e_form_invalid_class('receiver_email', $errors)}}"
                            name="receiver_email">
