                ...
                <div class="card mb-5 mb-lg-0">
                    <div class="card-body">
                        ...
                        <ul class="fa-ul">
                            ...
                            <li class="text-muted"><span class="fa-li"><i class="fa fa-times"></i></span>0 Premimum Job
                                Post
                            </li>
                            ...
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Dashboard access to manage
                                application</li>
                            <li class="text-muted"><span class="fa-li"><i class="fa fa-times"></i></span>E-Mail support
                            </li>
            ...
            <div class="col-lg-4">
                <div class="card mb-5 mb-lg-0 " style="background-color:#faf9b3;">
                    <div class="card-body">
                        ...
                        <hr>
                        <ul class="fa-ul">
                            <li><span class="fa-li"><i class="fa fa-check"></i></span><strong>Unlimited Regular Job
                                    Post</strong></li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>
