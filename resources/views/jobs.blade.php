                ...
                <form action="" method="get">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="gender" id="gender">
                            ...
                            <option value="any" {{ request('gender') == 'any' ? 'selected':'' }}>@lang('app.any')
                            </option>
                            <option value="male" {{ request('gender') == 'male' ? 'selected':'' }}>@lang('app.male')
                            </option>
                            <option value="female" {{ request('gender') == 'female' ? 'selected':'' }}>
                                @lang('app.female')</option>
                            <option value="transgender" {{ request('gender') == 'transgender' ? 'selected':'' }}>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="exp_level" id="exp_level">
                            ...
                            <option value="mid" {{ request('exp_level') == 'mid' ? 'selected':'' }}>@lang('app.mid')
                            </option>
                            <option value="entry" {{ request('exp_level') == 'entry' ? 'selected':'' }}>
                                @lang('app.entry')</option>
                            <option value="senior" {{ request('exp_level') == 'senior' ? 'selected':'' }}>
                                @lang('app.senior')</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <p class="text-muted mb-1"> Dsitrict</p>

                        <select name="district"
                            class="form-control {{e_form_invalid_class('country', $errors)}} country_to_state">
                            <option value="">Select a destrict</option>
                            @foreach(allDistricts() as $district)
                            <option value="{{ $district['name'] }}"
                                {{selected($district['name'], request('district'))}}>
                                {{ $district['name'] }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{route('jobs_listing')}}" class="btn btn-info text-white"><i class="la la-eraser"></i>
                            @lang('app.clear_filter')</a>
                    </div>
                </form>
