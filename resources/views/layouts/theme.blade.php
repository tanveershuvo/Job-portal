            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="footer-menu-wrap mt-2 text-center">
                        ...
                        <a href="" class="btn btn-sm btn-social-icon btn-circle-facebook mr-2">
                            <span class="fa fa-facebook"></span>
                        </a>
                        <a href="" class="btn btn-sm btn-social-icon btn-circle-google mr-2">
                            <span class="fa fa-google"></span>
                        </a>
                        <a href="" class="btn btn-sm btn-social-icon btn-circle-linkedin mr-2">
                            <span class="fa fa-linkedin"></span>
                        </a>
                        <a href="" class="btn btn-sm btn-social-icon btn-circle-github mr-2">
